...
<div class="content">
  <div class="container-fluid">
    <div class="row">
            ...
            <div class="card card-primary" >
              <div class="row">
                <div class="col-md-6 ">
                  ...
                  <div class="col mt-4" style="text-transform:capitalize;" >
                    ...
                    <label for="telefrecibe" class=" text-primary mt-4">Teléfono de persona que recibe:</label>
                    <input type="number" name="telefrecibe" id="telefrecibe" value="" class="form-control" placeholder="Indique el número de telefono de la persona que recibe">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="col  mt-4">
              ...
              <div class=" card-body"><br>
                ...
                <div class="col-md-12 mt-4">
                    ...
                    <div class="card-body">
                      ...
                      <div class="row mt-4">
                        ...
                        <div class="col-md-3">
                          ...
                          <input type="number" name="valortota" id="valortota" readonly value="" class="form-control">
                        </div>
                        <hr>
                        <hr>
                        <hr>
                          
                      <div class="container mt-4" id="masFactuas" style="display:none ;">
                        <div class="row  mt-4">
                          <div class="col-md-2">
                            <label class=" text-primary" for="fecha" class="form-label">Fecha de entrega</label>
                        ...
                        <div class="row  my-4">
                          ...
                          <div class="col-md-3">
                            <label class=" text-primary" for="lugar" class="form-label">Subtotal</label>
                            <input type="number" name="valortotados" id="valortotados" readonly value="" class="form-control">
                          </div>   
                        </div>
                        ...
                        <div class="row  mt-4" >
                          <div class="col-md-4">
                            ...
                            <select type="text" name="productotres" id="productotres" value="" class="form-control">
                              
                            </select>                      
                        </div>
                          <div class="col-md-2">
                            <label class=" text-primary" for="Cantidad" class="form-label">Cantidad</label>
                            <input type="number" name="cantidatres" id="cantidatres" value="" class="form-control">
                          </div>
                          <div class="col-md-2">
                            <label class=" text-primary" for="hora" class="form-label">Valor unitario</label>
                          ...
                          <div class="col-md-3">
                            <label class=" text-primary" for="lugar" class="form-label">Subtotal</label>
                            <input type="number" name="valortotatres" id="valortotatres" readonly value="" class="form-control">
                          </div>
                        ...
                        <div class="row  mt-4" >
                          <div class="col-md-4">
                            <label class=" text-primary" for="productodos" class="form-label">Producto a entregar</label>
                            <select type="text" name="productocuatro" id="productocuatro" value="" class="form-control">
                              
                            </select>                      
                        </div>
                        <div class="col-md-2">
                          <label class=" text-primary" for="Cantidad" class="form-label">Cantidad</label>
                          <input type="number" name="cantidadcuatro" id="cantidadcuatro" value="" class="form-control">
                        </div>
                        <div class="col-md-2">
                          <label class=" text-primary" for="hora" class="form-label">Valor unitario</label>
                        ...
                        <div class="col-md-3">
                          <label class=" text-primary" for="lugar" class="form-label">Subtotal</label>
                          <input type="number" name="valortotacuatro" id="valortotacuatro" readonly value="" class="form-control">
                        </div>
                      ...
                      <hr>
                        ...
                        <div class="row  mt-4" >
                          <div class="col-md-4">
                            <label class=" text-primary" for="productodos" class="form-label">Producto a entregar</label>
                            <select type="text" name="productocinco" id="productocinco" value="" class="form-control">
                              
                            </select>                      
                        </div>
                        <div class="col-md-2">
                          <label class=" text-primary" for="Cantidad" class="form-label">Cantidad</label>
                          <input type="number" name="cantidadcinco" id="cantidadcinco" value="" class="form-control">
                        </div>
                        <div class="col-md-2">
                          <label class=" text-primary" for="hora" class="form-label">Valor unitario</label>
                        ...
                        <div class="col-md-3">
                          <label class=" text-primary" for="lugar" class="form-label">Subtotal</label>
                          <input type="number" name="valortotacinco" id="valortotacinco" value="" class="form-control">
                        </div>
                  ...
                  <hr>
                  <div class="row mt-6 ml-2 mr-2 mt-4"  >
                    <div class="col-md-12">
                      <label class=" text-primary" for="lugar" class="form-label">Valor total de la factura:</label>
                      <input type="number" name="valortotalfinal" id="valortotalfinal" value="" class="form-control">
                    </div>
                ...
                <div class="row ml-4">
                  ...
                  <div class="col ml-2"> <a href="<?php echo e(url('solicitud/')); ?>" class="btn btn-primary">Regresar</a></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <script src="<?php echo e(asset('js/masProducto.js')); ?>"></script>
      <script src="<?php echo e(asset('js/main/autorizadores.js')); ?>"></script>
      <script src="<?php echo e(asset('js/main/proveedores.js')); ?>"></script>
      <script src="<?php echo e(asset('js/main/productos.js')); ?>"></script>
      <script src="<?php echo e(asset('js/main/subtotales.js')); ?>"></script>
...
<?php echo $__env->make('layouts.main', ['activePage' => 'Solicitud', 'titlePage' => __('Formulario de solicitud')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\refrigerios\resources\views/especial/create.blade.php ENDPATH**/ ?>