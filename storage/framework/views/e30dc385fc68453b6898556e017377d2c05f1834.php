                ...
                <div class="card col-md-12 mb-4">
                    ...
                    <div class="card-body">
                        <div class="table-responsive xl">
                          <?php $__empty_1 = true; $__currentLoopData = $especial; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $solicitu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                          <table class="table">
                            <thead class="text-primary">
                                <tr>
                                    <th></th>
                          ...
                          <tr>
                            ...
                            <td  class="text-"><a href="<?php echo e(route('especial.edit',$solicitu->id)); ?>" class="btn btn-warning"><?php echo e($solicitu->estado); ?></td>
...
<?php echo $__env->make('layouts.main', ['activePage' => 'Solicitud', 'titlePage' => __('Tabla de solicitud')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\refrigerios\resources\views/solicitud/index.blade.php ENDPATH**/ ?>